...
# A_BX_AVMS_CNT_0001           Connection between device and server when no job is running on server
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Connection between device and server when no job is running on server" % test_ID
    print "***********************************************************************************************************************"
