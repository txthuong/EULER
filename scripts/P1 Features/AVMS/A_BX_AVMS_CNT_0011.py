...
# A_BX_AVMS_CNT_0011           To test the device is not able to connect to DM server if the previous connection is still opened
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: To test the device is not able to connect to DM server if the previous connection is still opened" % test_ID
    print "***********************************************************************************************************************"
    ...
    print "\nStep 6: Re-initiate a connection to the Device Services server"
    SagSendAT(uart_com, 'AT+WDSS=1,1\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 4\r\n'], 20000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 6\r\n'], 20000)
    ...
    time.sleep(10)
    print "\nStep 7: Initiate another connection to the Device Services server while  previous connection is still opened"
    SagSendAT(uart_com, 'AT+WDSS=1,1\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 20000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 8\r\n'], 90000)
