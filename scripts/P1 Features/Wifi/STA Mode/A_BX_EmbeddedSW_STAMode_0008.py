...
# A_BX_EmbeddedSW_STAMode_0008                  Verify <ssid> notification of +SRWSTACON should be correct
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_STAMode_0008
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_STAMode_0008"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Verify <ssid> notification of +SRWSTACON should be corresponding to <action> (Operating mode)" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 4000)
    if SagWaitnMatchResp(aux1_com, ['*+SRWSTASTATUS: 1,"%s","%s",11,*\r\n' % (wifi_ssid, dut_mac_address)], 20000):
