...
# A_BX_EmbeddedSW_AP_STA_0042                   Verify <status> notification of +SRWSTACON should be corresponding to <action> (Operating mode)
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0042
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0042"
