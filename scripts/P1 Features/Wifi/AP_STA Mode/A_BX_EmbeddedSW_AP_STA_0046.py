...
# A_BX_EmbeddedSW_AP_STA_0046                   Verify <auth_mode> notification of +SRWSTACON should be correct
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0046
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0046"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Verify <auth_mode> notification of +SRWSTACON should be correct" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['+SRWSTASTATUS: 1,"%s","%s",11,3\r\n' %(wifi_ssid, aux1_mac_address)], 3000)
