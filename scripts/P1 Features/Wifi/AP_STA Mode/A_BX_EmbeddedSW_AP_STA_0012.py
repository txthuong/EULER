...
# A_BX_EmbeddedSW_AP_STA_0012                   Use command +SRWAPCFG to configure authentication mode as WPA2 Enterprise
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0012
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0012"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Use command +SRWAPCFG to configure authentication mode as WPA2 Enterprise" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['+SRWSTASTATUS: 1,"%s","%s",5,5\r\n' % (wifi_ssid, dut_mac_address)], 3000 )
