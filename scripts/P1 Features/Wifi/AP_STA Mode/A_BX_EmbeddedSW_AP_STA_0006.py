...
# A_BX_EmbeddedSW_AP_STA_0006                   Use command +SRWAPCFG to configure pass-key with mix characters (numbers, strings, special characters)
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0006
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0006"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Use command +SRWAPCFG to configure pass-key with mix characters (numbers, strings, special characters)" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 4: Setup Access Point with passkey mix characters\n"
    wifi_password = '12345678x@X'
    ...
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['+SRWSTASTATUS: 1,"%s","%s",5,3\r\n' % (wifi_ssid, dut_mac_address)], 2000 )
