...
# A_BX_EmbeddedSW_AP_STA_0001                   Use command +SRWCFG to configure module works as AP and STA in parallel (default country)
#
# Requirement
# 1 Euler module
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0001
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0001"
