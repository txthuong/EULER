...
# A_BX_EmbeddedSW_AP_STA_0027                   Use command +SRWAPNETCFG to configure the start assigned IP address with Class B and use number 0 as host IP address
#
# Requirement
# 1 Euler module
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0027
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0027"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Use command +SRWAPNETCFG to configure the start assigned IP address with Class B and use number 0 as host IP address" % test_ID
    print "*****************************************************************************************************************"
