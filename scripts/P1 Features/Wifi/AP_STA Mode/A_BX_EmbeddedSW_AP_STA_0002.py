...
# A_BX_EmbeddedSW_AP_STA_0002                   Use command +SRWCFG to configure module works as AP and STA in parallel and combine with <country> as Japan
#
# Requirement
# 1 Euler module
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0002"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Use command +SRWCFG to configure module works as AP and STA in parallel and combine with <country> as Japan" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagSendAT(uart_com, 'AT+SRWCFG=3,1\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
