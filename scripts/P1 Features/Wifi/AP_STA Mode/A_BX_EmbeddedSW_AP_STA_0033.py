...
# A_BX_EmbeddedSW_AP_STA_0033                   Use command +SRWAPNETCFG to configure the start and end assigned IP address with Class B (Ex: 172.16.0.2 - 172.16.0.101). The IP address pool size should be 100
#
# Requirement
# 1 Euler module
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0033
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0033"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Use command +SRWAPNETCFG to configure the start and end assigned IP address with Class B (Ex: 172.16.0.2 - 172.16.0.101). The IP address pool size should be 100" % test_ID
    print "*****************************************************************************************************************"
