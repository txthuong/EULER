...
# A_BX_EmbeddedSW_AP_STA_0008                   Use command +SRWAPCFG to configure authentication mode as WEP
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0008
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0008"
...
try:
    ...
    # WEP is not supported, will fallback to open
