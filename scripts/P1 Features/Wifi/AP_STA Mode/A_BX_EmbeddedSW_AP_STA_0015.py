...
# A_BX_EmbeddedSW_AP_STA_0015                   Use command +SRWAPCFG to configure channel 14
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0015
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0015"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Use command +SRWAPCFG to configure channel 14" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['+SRWSTASTATUS: 1,"%s","%s",14,3\r\n' % (wifi_ssid, dut_mac_address)], 3000 )
...
SagSendAT(aux1_com, 'AT+SRWSTANETCFG=0"\r')
SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
