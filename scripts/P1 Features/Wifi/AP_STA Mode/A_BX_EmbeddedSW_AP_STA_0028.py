...
# A_BX_EmbeddedSW_AP_STA_0028                   Use command +SRWAPNETCFG to configure the start assigned IP address with Class C and use number 0 as host IP address
#
# Requirement
# 1 Euler module
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0028
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0028"
