...
# A_BX_EmbeddedSW_AP_STA_0030                    Use command +SRWAPNETCFG to configure the end assigned IP address with Class B and use number 255 as host IP address
#
# Requirement
# 1 Euler module
#  
