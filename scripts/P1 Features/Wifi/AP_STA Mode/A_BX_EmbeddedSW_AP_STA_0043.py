...
# A_BX_EmbeddedSW_AP_STA_0043                   Verify <ssid> notification of +SRWSTACON should be correct
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0043
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0043"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Verify <ssid> notification of +SRWSTACON should be correct" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagSendAT(aux1_com, 'AT+SRWAPCFG="%s","%s",4,5,1,100\r' %(wifi_ssid, wifi_password))
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    ...
    print "\nStep 7: Configure the station connection\n"
    ...
    print "\nStep 11: Disconnect to the access point\n"
