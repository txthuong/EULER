...
# A_BX_EmbeddedSW_AP_STA_0018                   Use command +SRWAPCFG to configure beacon interval as 1000ms
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0018
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0018"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Use command +SRWAPCFG to configure beacon interval as 1000ms" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['+SRWSTASTATUS: 1,"%s","%s",1,3\r\n' % (wifi_ssid, dut_mac_address)], 3000 )
