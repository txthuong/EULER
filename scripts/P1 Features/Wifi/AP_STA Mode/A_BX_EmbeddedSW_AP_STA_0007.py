...
# A_BX_EmbeddedSW_AP_STA_0007                   Use command +SRWAPCFG to configure authentication mode as Open
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AP_STA_0007
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AP_STA_0007"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Use command +SRWAPCFG to configure authentication mode as Open" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagSendAT(uart_com, 'AT+SRWAPCFG="%s","%s",0,5,0,100\r' %(wifi_ssid, wifi_password))
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    ...
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['+SRWSTASTATUS: 1,"%s","%s",5,0\r\n' % (wifi_ssid, dut_mac_address)], 2000 )
