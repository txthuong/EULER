...
# A_BX_EmbeddedSW_AP_STA_0004                   Use command +SRWCFG to configure module works as AP and STA in parallel and combine with <country> as EU
#
# Requirement
# 1 Euler module
#  
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Use command +SRWCFG to configure module works as AP and STA in parallel and combine with <country> as EU" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagSendAT(uart_com, 'AT+SRWCFG=3,3\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
