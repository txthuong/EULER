...
# A_BX_EmbeddedSW_KUDP_DATA_0005                To check "+KUDP_DATA" can be received in UDP client to indicate there are incoming data with <data_mode>=1
#
# Requirement
# 2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KUDP_DATA_0005
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KUDP_DATA_0005"
...
try:
    ...
    SagSendAT(aux1_com, 'AT+KUDPSND=1,"%s",1234,"A_INTEL_PROTOCOM_KUDPSND_0005"\r' %uart_UDP_ip)
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    print '\nDUT: Check URC "+KUDP_DATA" is received\n'
    SagWaitnMatchResp(uart_com, ['\r\n+KUDP_DATA: 1,29,"%s",*,A_INTEL_PROTOCOM_KUDPSND_0005\r\n' %aux1_UDP_ip], 2000)
    
    print '\nStep 11: AUX: Checking UDP Connection Configuration\n'
    SagSendAT(aux1_com, 'AT+KUDPCFG?\r')
    ...
    print '\nStep 10:DUT: Send data to CLIENT\n'
    SagSendAT(uart_com, 'AT+KUDPSND=1,"%s",%s,"A_INTEL_PROTOCOM_KUDPSND_0001"\r' %(aux1_UDP_ip,aux1_port))
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    print '\nAUX: Check URC "+KUDP_DATA" is received\n'
    SagWaitnMatchResp(aux1_com, ['\r\n+KUDP_DATA: 1,29,"%s",*,A_INTEL_PROTOCOM_KUDPSND_0001\r\n' %uart_UDP_ip], 2000)
