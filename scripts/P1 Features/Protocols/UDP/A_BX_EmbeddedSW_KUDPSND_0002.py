...
# A_BX_EmbeddedSW_KUDPSND_0002                  Check that module can receive data from PC via UDP connection
#
# Requirement
# 1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KUDPSND_0002
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KUDPSND_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s: Check that module can receive data from PC via UDP connection" % test_ID
    print "***************************************************************************************************************"
    ...
    print '\nStep 6: Send data to module UDP server from PC\n'
    wx.MessageBox('Send data to module UDP server then click "OK"', 'Info',wx.OK)
