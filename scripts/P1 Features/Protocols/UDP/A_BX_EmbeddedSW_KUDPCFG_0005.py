...
# A_BX_EmbeddedSW_KUDPCFG_0005                   To check UDP client configuration with <udp remote address>
# 
# Requirement
# 2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KUDPCFG_0005
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KUDPCFG_0005"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:To check UDP client configuration with <udp remote address>" % test_ID
    print "***************************************************************************************************************"
    ...
    print '\nStep 6: AUX: UDP Connection Configuration with <mode>=0\n'
    SagSendAT(aux1_com, 'AT+KUDPCFG=,0\r')
    SagWaitnMatchResp(aux1_com, ['\r\n+KUDPCFG: 1\r\n'], 3000)
    SagWaitnMatchResp(aux1_com, ['*OK\r\n'], 3000)
    
    print '\nStep 7: AUX: Display IP Address of the current connection\n'
    ...
    print '\nStep 8: AUX: Checking UDP Connection Configuration\n'
    ...
    print '\nStep 11: DUT: Close created session\n'
    SagSendAT(uart_com, 'AT+KUDPCLOSE=1\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 12: DUT: Delete UDP Connection after closing it\n'
