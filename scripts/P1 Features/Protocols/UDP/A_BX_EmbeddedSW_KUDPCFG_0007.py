...
# A_BX_EmbeddedSW_KUDPCFG_0007                  To check Maximum <session_id> is 64 for UDP client/server
#
# Requirement
# 1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KUDPCFG_0007
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KUDPCFG_0007"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s: To check Maximum <session_id> is 64 for UDP client/server" % test_ID
    print "***************************************************************************************************************"
    ...
    print '\nStep 4: Configure UDP server session\n'
    SagSendAT(uart_com, 'AT+KUDPCFG=,1,0\r')
    SagWaitnMatchResp(uart_com, ['\r\n+KUDPCFG: 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    
    print '\nStep 5: Repeat step 4 for 63 times \n'
    for i in range (2,65):
    ...
    print '\nStep 6: Try to create UDP client session 65\n'
    SagSendAT(uart_com, 'AT+KUDPCFG=,0\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 912\r\n'], 2000)
    
    print '\nStep 7: Try to create UDP server session 65\n'
    SagSendAT(uart_com, 'AT+KUDPCFG=,1,1033\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 912\r\n'], 2000)
    ...
    print '\nStep 9: Close created session\n'
    SagSendAT(uart_com, 'AT+KUDPCLOSE=1\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 10: Delete UDP Connection after closing it\n'
    for i in range (1,65):
