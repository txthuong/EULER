...
# A_BX_EmbeddedSW_KUDP_DATA_0002                To check "+KUDP_DATA" can be received in UDP server to indicate there are an incoming data
#
# Requirement
# 2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KUDP_DATA_0002
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KUDP_DATA_0002"
...
try:
    ...
    SagSendAT(aux1_com, 'AT+KUDPSND=1,"%s",1234,"A_INTEL_PROTOCOM_KUDPSND_0001"\r' %uart_UDP_ip)
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
