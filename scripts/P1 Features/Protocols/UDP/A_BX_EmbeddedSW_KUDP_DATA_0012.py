...
# A_BX_EmbeddedSW_KUDP_DATA_0012                Check that +KUDP_DATA supports client <session_id> 1 - 64
#
# Requirement
# 1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KUDP_DATA_0012
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KUDP_DATA_0012"
...
try:
    ...
    for i in range (1,65):
        ...
        SagSendAT(uart_com, 'AT+KUDPSND=%s,"%s",%s,"A_BX_EmbeddedSW_KUDP_DATA_0012"\r' %(i, udp_server, udp_port))
        SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
        
        print '\nCheck URC "+KUDP_DATA" is received\n'
        SagWaitnMatchResp(uart_com, ['\r\n+KUDP_DATA: %s,30,"%s",*,A_BX_EmbeddedSW_KUDP_DATA_0012\r\n' %(i, udp_server)], 5000)
    ...
    print '\nStep 126 Delete UDP Connection after closing it\n'
    for i in range (1,65):
