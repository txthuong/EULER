...
# A_BX_EmbeddedSW_KUDPDEL_0004                  Check that +KUDPDEL supports server <session_id> 1 - 64
#
# Requirement
# 1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KUDPDEL_0004
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KUDPDEL_0004"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:  Check that +KUDPDEL supports server <session_id> 1 - 64" % test_ID
    print "***************************************************************************************************************"
    ...
    print '\nStep 4: Configure module as server and 64 UDP sockets (n in range 1-64)\n'
    for i in range (1,65):
        SagSendAT(uart_com, 'AT+KUDPCFG=,1,%s\r' %(8800+i))
        SagWaitnMatchResp(uart_com, ['\r\n+KUDPCFG: %s\r\n' %i], 2000)
    ...
    SagWaitnMatchResp(uart_com, ['\r\n+KUDPCFG: 1,,1,0,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['*+KUDPCFG: 64,,1,0,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
