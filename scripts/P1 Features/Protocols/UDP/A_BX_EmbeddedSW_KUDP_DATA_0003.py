...
# A_BX_EmbeddedSW_KUDP_DATA_0003                To check "+KUDP_DATA" can be received on the module when data from PC server is received
#
# Requirement
# 1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KUDP_DATA_0003
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KUDP_DATA_0003"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:To check +KUDP_DATA can be received on the module when data from PC server is received" % test_ID
    print "***************************************************************************************************************"
    ...
    SagSendAT(uart_com, 'AT+KUDPSND=1,"%s",%s,"A_INTEL_PROTOCOM_KUDPSND_0003"\r' %(udp_server, udp_port))
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nCheck URC "+KUDP_DATA" is received\n'
    SagWaitnMatchResp(uart_com, ['\r\n+KUDP_DATA: 1,29,"%s",*,A_INTEL_PROTOCOM_KUDPSND_0003\r\n' %udp_server], 2000)
