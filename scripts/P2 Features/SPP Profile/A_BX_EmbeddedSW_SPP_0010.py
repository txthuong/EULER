...
# A_BX_EmbeddedSW_SPP_0010                      Check that module can properly start/close SPP connection several times
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0010
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0010"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check that module can properly start/close SPP connection several times" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 5: DUT: Activate connection to AUX\n"
    ...
    print "\nStep 6: DUT: Send data to AUX\n"
    SagSendAT(uart_com, 'AT+SRSPPSND=1, "Hello Euler"\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    SagWaitnMatchResp(aux1_com, ['+SRSPP_DATA: 1,11,Hello Euler\r\n'], 5000)

    print "\nStep 7: AUX: Send data to DUT\n"
    SagSendAT(aux1_com, 'AT+SRSPPSND=1, "Hello Euler"\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    
    SagWaitnMatchResp(uart_com, ['+SRSPP_DATA: 1,11,Hello Euler\r\n'], 5000)
    
    print "\nStep 8: AUX: Close SPP connection\n"
    ...
    for i in range (1,5):
        ...
        print '\nRepeat step 5 to step 8 many times\n'
    
    print "\nStep 8: DUT: Try to delete SPP connection\n"
